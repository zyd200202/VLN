...
SWEEP_ROWS = [
    ...
    ("Where-to-go",     "M1g",                   "$r$-gated value-map reweight",   RUNS/"redesign_n300/n300_M1g_low_light_s4_seed0.csv",       "300", RUNS/"redesign_n300/n300_B0_low_light_s4_seed0.csv"),
    ...
    ("Forced commit",   "CRV",                   "close-range recall verifier",    RUNS/"unified/u_CRV_low_light_s4_seed0_N150.csv",            "150", RUNS/"maintable/mt_B0_low_light_s4_seed0.csv"),
    ("Temporal",        "MUAP",                  "hold-frames + re-observe",       RUNS/"unified/u_MUAP_low_light_s4_seed0_N150.csv",           "150", RUNS/"maintable/mt_B0_low_light_s4_seed0.csv"),
    ...
    ("Multimodal probe", r"DXCV$^{\flat}$",       "depth cross-modal veto",        RUNS/"unified/u_DXCV_low_light_s4_seed0_N150.csv",          "150", RUNS/"maintable/mt_B0_low_light_s4_seed0.csv"),
]
...
r"diagnosis in \emph{Sample Size and Scope}. The commitment-on-degraded-input",
