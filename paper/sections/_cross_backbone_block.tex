...
RGB restoration (RES) against the frozen baseline (B0), ($\Delta$SPL is similarly null on every
...
diagnosis in \emph{Cross-Corruption Replication}. The commitment-on-degraded-input
