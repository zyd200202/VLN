...
$N{=}300$ low-light~sev~$4$~seed~$0$ comparison. Each row is the \emph{same}
...
($N{=}12$ sub-sample of the $N{=}150$ low-light~sev~$4$~seed~$0$ paired
...
Tab.~\ref{tab:og-vignettes}: 21 out of 300 rescued, 36 out of 300 broken,
